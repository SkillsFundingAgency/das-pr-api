...
public class GetEmployerRelationshipsQueryValidator : AbstractValidator<GetEmployerRelationshipsQuery>
{
    ...
    public GetEmployerRelationshipsQueryValidator(IEmployerRelationshipsReadRepository employerReadRepository)
    {
        ...
        RuleFor(a => a.AccountId)
            .MustAsync(employerReadRepository.AccountIdExists)
