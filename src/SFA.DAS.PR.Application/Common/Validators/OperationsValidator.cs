...
public static class OperationsValidator
{
    ...
    public const string OperationsCombinationValidationMessage = "Operations array can have a maximum of two items and must be one of the valid combinations: 0, 1, 2, 0,1, 0,2.";
